...
public class JdbcUserDao implements UserDao {
    ...
    public boolean create(String username, String password) {
        ...
        String sql = "INSERT INTO tenmo_user (username, password_hash, balance) VALUES (?, ?,?) RETURNING user_id";
        String password_hash = new BCryptPasswordEncoder().encode(password);
        Integer newUserId;
        newUserId = jdbcTemplate.queryForObject(sql, Integer.class, username, password_hash,1000);
    ...
    private User mapRowToUser(SqlRowSet rs) {
        ...
        user.setBalance(new BigDecimal(rs.getInt("balance")));
